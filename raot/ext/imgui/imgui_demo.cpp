...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
	...
	if (ImGui::TreeNode("Color/Picker Widgets"))
	{
		...
		// Always display a small version of both type of pickers
	...
	{
		// DragScalar/InputScalar/SliderScalar functions allow various data type
		// - signed/unsigned
		// - 8/16/32/64-bits
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
	...
	// Tip: If you do a lot of custom rendering, you probably want to use your own geometrical type and benefit of
	// overloaded operators, etc. Define IM_VEC2_CLASS_EXTRA in imconfig.h to create implicit conversions between your
	// type and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to imgui.cpp and not
	// exposed outside (to avoid messing with your type) In this example we are not using the maths operators!
