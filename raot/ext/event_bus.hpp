...
namespace dxg {
	...
	class handler_registration {
		...
		dxg::event_bus* event_bus_{ nullptr };
	...
	protected:
		handler_registration(const void* handle, dxg::event_bus* bus);
	...
	inline handler_registration::handler_registration(const void* handle, dxg::event_bus* bus)
